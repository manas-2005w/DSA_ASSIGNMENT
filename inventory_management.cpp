...
//         cout << "Product: " << inventory[i].name << ", Quantity: " << inventory[i].quantity << "\n";
//     }
//     cout << "-------------------\n";
// }

// void updateInventory(Product inventory[], int& size, const string productName, int quantity) {
//    // product check karo hai ki nahi 
//     for (int i = 0; i < size; ++i) {
...
//         }
//     }
//     if (size < 100) { //agar bas 100 product hue toh
//         inventory[size].name = productName;
//         inventory[size].quantity = quantity;
//         size++;
//     } else {
//         cout << "Inventory is full. Cannot include more items in the inventory.\n";
//     }
// }
...
//     updateInventory(inventory, inventorySize, "Product1", 50);
//     updateInventory(inventory, inventorySize, "Product2", 30);
//     updateInventory(inventory, inventorySize, "Product1", 20); 
